...
# Main
model = "/workspace/DBT_US_Soroka/Codes/DBT/2D/statistics/ssl-results/test_prediction-checkpoint.4.ckpt.csv"
#model = "/workspace/DBT_US_Soroka/Codes/DBT/2D/self_supervised_mean-teacher/ssl-weight-384-experiment/pseudo_exp/test_prediction-student_model-ssl1-lr8-loss-CE-PSEUDO-EXT.pth.csv"
...
case_true, _, case_prob = case_based(scan_names, scans_prob, scans_true)
